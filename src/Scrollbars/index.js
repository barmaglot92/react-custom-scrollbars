...
export default class Scrollbars extends Component {
    ...
    addListeners() {
        ...
        if (!getScrollbarWidth(this.props.defaultScrollbarWidth)) return;
    ...
    _update(callback) {
        ...
        if (getScrollbarWidth(this.props.defaultScrollbarWidth)) {
    ...
    render() {
        const scrollbarWidth = getScrollbarWidth(this.props.defaultScrollbarWidth);
